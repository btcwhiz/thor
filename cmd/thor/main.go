...
import (
	...
	"github.com/BestSilverTiger/thor/api"
	"github.com/BestSilverTiger/thor/cmd/thor/node"
	"github.com/BestSilverTiger/thor/cmd/thor/pruner"
	"github.com/BestSilverTiger/thor/cmd/thor/solo"
...
func main() {
	app := cli.App{
		Version:   fullVersion(),
		Name:      "Thor",
		Usage:     "Node of Dexio Thor Network",
		Copyright: "2022 Dexigas Foundation <https://Dexigas.com//>",
		Flags: []cli.Flag{
			networkFlag,
			configDirFlag,
			dataDirFlag,
